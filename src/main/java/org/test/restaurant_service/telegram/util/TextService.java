...
class TextService {
    ...
    public String getWebSiteText(Long chatId) {
        return String
                .format("🌟 Привет! Добро пожаловать на наш сайт: [parktown.md](http://195.133.27.38/#menu/%s). Мы рады, что вы с нами! 😊", chatId);
    }
    ...
    public String getDefaultMessage(Long chatId) {
        return String.format("""
                ...
                Можете посмотреть наше меню /menu ☺ или сделать заказ у нас на сайте [parktown.md](http://195.133.27.38/#menu/%s).""", chatId);
    }
}
